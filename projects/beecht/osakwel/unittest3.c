...
int main() {
    ...
    // Run mine function
    result = mineCardEffect(state, state->whoseTurn, 1, silver, 0);
    ...
    // Run mine function
    result = mineCardEffect(state, state->whoseTurn, 1, gold, 0);
    ...
    // Run mine function
    result = mineCardEffect(state, state->whoseTurn, 1, feast, 0);
    ...
    // Run mine function
    result = mineCardEffect(state, state->whoseTurn, 1, copper, 0);
