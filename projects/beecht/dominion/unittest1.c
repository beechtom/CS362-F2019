...
int main() {
    ...
    result = card_effect_ambassador(1, 1, 0, state);
    ...
    result = card_effect_ambassador(1, 2, 0, state);
    ...
    assert("it does not allow discarding negative cards",
            result == -1);
    result = card_effect_ambassador(1, 3, 0, state);
    assert("it does not allow discarding more than 2 cards",
            result == -1);
    result = card_effect_ambassador(0, 1, 0, state);
